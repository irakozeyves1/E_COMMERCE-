...
<center> <form method="post" action="buyingpage.php">
 <table><tr><td> <input name="search" type="text" /></td><td> <input type="submit" value="Search" /></td></tr></table>
              ...
              <center>  <table cellpadding="0" cellspacing="1" border="1" bordercolor="#6600FF" class="table table-striped table-bordered" >
                    ...
                    <thead>
                         <tr bordercolor="#0000FF" bgcolor="#99CCFF"> <th>ID</th><th>DATE</th><th>CUSTOMER NAMES</th><th>NATIONAL ID</th><th>TELEPHONE NUMBER</th><th>PRODUCT NAME</th><th>TYPE</th><th>SIZE</th><th>QUANTITY</th><th>UNIT PRICE</th><th>TOTAL PRICE</th><th>RECEIVED</th><th>COMMENT</th><th>pay</th></tr>
                    </thead>
                    <tbody bgcolor="#99CC99">
                        <?php
                        $search=$_REQUEST['search'];
$query="select * from shirt where n_id like '%$search%' or date like '%$search%' or n_id like '%$search%' or teleph like '%$search%'";
$query1=mysql_query($query);
	 ...
	 echo"<td ><a href ='shoesup.php?s_id=$id'>";?><button type="button" name="Submit" onClick="return confirm('payment transaction!!')">pay</button><?php print"</a></td>";
