...
<center> <form method="post" action="commentview.php">
 <table><tr><td> <input name="search" type="text" /></td><td> <input type="submit" value="Search" /></td></tr></table>
              ...
              <center>  <table cellpadding="0" cellspacing="1" border="0" bordercolor="#6600FF" class="table table-striped table-bordered" >


                    <thead>
                         <tr bordercolor="#0000FF" bgcolor="#99CCFF"> <th>DATE</th><th>COMMENT</th></tr>
                    </thead>
                    <tbody bgcolor="#99CC99">
                        <?php
                        $search=$_REQUEST['search'];
$query="select * from comment where date like '%$search%' or comment like '%$search%'";
