...
<center> <form method="post" action="shoessearch.php">
 <table><tr><td> <input name="search" type="text" /></td><td> <input type="submit" value="Search" /></td></tr></table>
              ...
              <center>  <table cellpadding="0" cellspacing="1" border="1" bordercolor="#6600FF" class="table table-striped table-bordered" >
                    ...
                    <thead>
                         <tr bordercolor="#0000FF" bgcolor="#99CCFF"> <th>ID</th><th>DATE</th><th>CUSTOMER NAMES</th><th>NATIONAL ID</th><th>TELEPHONE NUMBER</th><th>TYPE</th><th>SIZE</th><th>QUANTITY</th><th>UNIT PRICE</th><th>TOTAL PRICE</th><th>RECEIVED</th><th>COMMENT</th></tr>
                    </thead>
                    <tbody bgcolor="#99CC99">
                        <?php
                        $query = mysql_query("SELECT * FROM  shirt WHERE recieved='yes'") or die(mysql_error());
