...
<div style="width:750px; height:500px; background-image:url(photos/hhh.png); float:right "><left>
...
<tr><td>TYPE:</td><td><select name="name4" required/>
    ...
    <option value="Snakers">Snakers</option>
	<option value="shoe soles">shoe soles</option>
