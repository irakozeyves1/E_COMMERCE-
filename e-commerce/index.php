...
<div style="width:250px; height:100px; background-color:"#FFFFCC";   "><a href="shoes.php"><img src="photos/shoes.gif" width="180px"; height="100px"/></a></div>
<div style="width:250px; height:100px; background-color:"#FFFFCC";   "><a href="impa.php"><img src="photos/ipantaro.gif" width="180px"; height="100px"/></a></div>
<div style="width:250px; height:100px; background-color:"#FFFFCC";  "><a href="boxer.php"><img src="photos/box.gif" width="180px"; height="100px"/></a></div>
<div style="width:250px; height:100px; background-color:"#FFFFCC";  "><a href="t_shirt.php"><img src="photos/t_shirt.gif" width="180px"; height="100px"/></a></div>
<div style="width:250px; height:100px; background-color:"#FFFFCC";   "><a href="shirtima.php"><img src="photos/shirt.gif" width="180px"; height="100px"/></a></div></div>


<div style="width:750px; height:500px; background-image:url(photos/body.jpg); float:right "><form method="post" action="commentsend.php">
<table align="right" width="500px"; height="400px"> 


<tr><td align="right"><textarea name="name1" cols="40" rows="5" placeholder="Type your Comment"></textarea><button type="submit" name="Submit" value="submit">Send</button></td></tr>
...
<div style="width:1000px; height:100px; background-image:url(photos/fooo.png) "></div>
